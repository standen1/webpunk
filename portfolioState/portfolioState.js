...
export const pressureSensitive = {
	...
	builtWith: ["Next", "React", "CSS3", "Node", "Styled Components", "Axios",
		"React Transition Group", "CSS3"]
}
...
export const discoDeathBots = {
	...
	builtWith: ["Frontity", "React", "CSS3", "Axios", "Node", "Styled Components",
...
export const apptech = {
	...
	builtWith: ["Wordpress", "PHP", "Bootstrap", "JQuery", "CSS3", "Ajax"]
}
...
export const robofriends = {
	...
	builtWith: ["React", "CSS3", "Tachyons", "Fetch", "Robohash API", 
